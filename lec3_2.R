...
#### Think about the value that the function pchisq returned. Is it the same as CHIINV? No!
#### CHIINV works with the right tail, so you had to use 1-CHINV in that question.
